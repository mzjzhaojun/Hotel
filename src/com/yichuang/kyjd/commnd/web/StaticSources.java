...
public class StaticSources {
	...
	public static final Integer SC_LOGINNAME_ERROR = 701;//用户名错误
	
	public static final Integer SC_LOGINPWD_ERROR = 702;//用户密码错误
	//==============================================================================================================
	...
	public static final String ERRsystemSG = "errsystemsg";
